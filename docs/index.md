...
![新規メディア登録](image_10.png)
![新規メディア登録](image_11.png)
...
- サイト TOP ページの URL を登録ください。
    ...
    - 開発中アプリについては下記 URL で申請頂き、審査通過次第、本番のURL の変更をお願い致します。
        - iOS: [https://itunes.apple.com/](https://itunes.apple.com/)
        - Android: [https://play.google.com/](https://play.google.com/)
...
## メディアへのタグ設置について：web メディア（メディア種別：Mobile Web / WebView App）
...
## 新規広告枠登録について：App メディア / インフィード広告（メディア種別：iOS App / Android App ）
- メディア名をクリックすると、メディア画面に遷移します。広告枠 ID に関しては、 「広告枠の新規登録」ボタンより行います。
- 「広告枠の新規登録」ボタンを押していただくと、広告枠登録画面が表示されます。
...
## 新規広告枠 ID 登録について：Appメディア / インタースティシャル広告（メディア種別：iOS APP/Android APP）
- メディア名をクリックすると、メディア画面に遷移します。広告枠 ID に関しては、 「広告枠の新規登録」ボタンより行います。
- 「広告枠の新規登録」ボタンを押していただくと、広告枠登録画面が表示されます。
    - 以下項目を入力していただき、保存ボタンを押していただく事で広告枠が発行されます。
    ![新規広告枠 ID 登録](image_18.png)
...
## アプリメディアへの SDK 実装について：App メディア（メディア種別：iOS App / Android App ）
...
- URL 単位での広告ブロック機能について
    ...
    ![URL 単位での広告ブロック機能について](image_19.png)
...
- 広告主カテゴリー単位でのブロックも可能となっております。
    ...
    ![カテゴリー単位でのブロックについて](image_20.png)
...
![広告レビュー（クリエイティブ単位でのブロック）について](image_22.png)
